...
export function Stat({
  ...
  return (
    <div className="border hairline bg-ink/40 p-4 sm:p-5">
      <p className="label text-bone-quiet">{label}</p>
      <p className={`font-display mt-2 text-3xl sm:text-4xl ${accent ? "text-gold" : "text-bone"}`}>{value}</p>
      {delta != null && (
