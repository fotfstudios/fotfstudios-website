...
/**
 * The page's single conversion action: every CTA on /grabacion renders this
...
export default function WhatsAppCta({
  ...
  const handleClick = () => {
    ...
    window.dataLayer?.push({ event: "whatsapp_click", source, page: "grabacion" });
    track("whatsapp_click", { source, page: "grabacion" });
  };

  return (
    <a
      href={whatsappLink(GRABACION.waMessage)}
      target="_blank"
