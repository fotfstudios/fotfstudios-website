...
export default async function Image() {
  ...
  const photoSrc = `data:image/jpeg;base64,${read("public/photos/cabina-10.JPG").toString("base64")}`;
      ...
      <div style={{ position: "relative", width: "100%", height: "100%", display: "flex", backgroundColor: INK }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              <div style={{ color: BONE }}>Guía de iniciación</div>
              <div style={{ color: GOLD }}>al DJing · gratis</div>
            </div>
            ...
            >
              <div style={{ color: BONE_DIM }}>PDF · 8 PÁGINAS · TE LLEGA AL CORREO</div>
